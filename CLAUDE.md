...
Current phase: Phase 12C complete — group membership + invite-code foundation (cross-account group visibility works; group trips/events still owner-scoped → Phase 12D)
